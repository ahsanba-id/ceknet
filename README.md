...
4. Copy the 'ceknet.py' file into the folder. You only need 'ceknet.py'. Files with a .lang extension is for translation purposes. If you want it in English, you can ignore or delete the .lang file."
